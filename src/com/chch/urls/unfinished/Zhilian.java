...
public class Zhilian implements Judge {
	...
	public String getWebString(String phoneNum) throws IOException {
		...
		// String param =
		// "MmEwMD=1jS79g3yl70WnUmDNdlwYVGmSpHztfHFHPknM.Fq66lUjrdsUZB9SqCmCh.XTyOaZiHc7CN0SdzFrFX4pN4_uM9DsWYXMCR8dJijMSVfQRpPA0wjImbxVCHPWS7XWutbvsE8TcmbxN41CNUPVntUWAe9TCCOG7waLOQQgwA830tK8ZbT3VjPSJVt6Tn0RisiJYUUwhTBNDA8W2UvOOYIwnbxwPzJSc3NQikE34_GE0Sc31Ol4p4UtDF_iY3zKQekOJlC9uECOsIQyd7CvL7bEVrLw7gEEzxWf5_67Fx_BplkpG4OodLLDX.ZpaN8H_WaoLBrmJ_yaWbuO2Tgfqo9sPDaxBxkRJs9BAgATGIfmmNi7IK3MfEVOzaCyIkl0mj28ffpMJNirQY7uG2By.AI5QZuRQP6RTHo.pvZ&Receiver="
		// + phoneNum + "&registername=" + phoneNum;
		...
		connection.setRequestProperty("Host", "passport.zhaopin.com");
		connection.setRequestProperty("User-Agent",
				"Mozilla/5.0 (Windows NT 10.0; WOW64; rv:54.0) Gecko/20100101 Firefox/54.0");
		connection.setRequestProperty("Referer", "https://passport.zhaopin.com/account/checkexist");
