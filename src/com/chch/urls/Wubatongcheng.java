...
//		System.out.println(result);
	...
	public boolean isRegister(String phoneNum) throws IOException {
		...
		Judge j = new Wubatongcheng();
		String result = j.getWebString(phoneNum);
